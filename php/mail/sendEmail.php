...
try {
    ...
    //Recipients
    $mail->setFrom('colebot@colebot.com', 'Colebot Himself');
    $mail->addAddress('colebot17@gmail.com', 'Cole Ruth');     //Add a recipient
    $mail->addAddress('coleruth25@mccallie.org');               //Name is optional
